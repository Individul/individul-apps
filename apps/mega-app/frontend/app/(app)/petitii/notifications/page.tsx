...
export default function NotificationsPage() {
  ...
  const handleMarkAllRead = async () => {
    ...
    try {
      ...
      fetchNotifications()
      toast.success('Toate notificarile au fost marcate ca citite')
    } catch {
      toast.error('A aparut o eroare')
    }
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Notificari</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Toate notificarile</CardTitle>
        </CardHeader>
        <CardContent>
          {loading ? (
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {!notification.is_read && (
                          <Badge variant="secondary" className="text-xs">Noua</Badge>
                        )}
                      </div>
                      <p className="text-sm">{notification.message}</p>
                      <div className="flex items-center gap-4 mt-2">
                        <Link
                          href={`/petitii/${notification.petition}`}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-muted-foreground">Nu aveti notificari</p>
            </div>
          )}
        </CardContent>
      </Card>
