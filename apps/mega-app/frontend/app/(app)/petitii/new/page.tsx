...
const formSchema = z.object({
  ...
  petitioner_type: z.string().min(1, 'Selectati tipul petitionar'),
  petitioner_name: z.string().min(1, 'Introduceti numele petitionar'),
  detainee_fullname: z.string().optional(),
  detention_sector: z.string().min(1, 'Selectati sectorul de detentie'),
  object_type: z.string().min(1, 'Selectati tipul obiect'),
...
export default function NewPetitionPage() {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      toast.success('Petitia a fost inregistrata cu succes')
      router.push(`/petitii/${petition.id}`)
    } catch (error) {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-2xl font-semibold">Inregistrare petitie noua</h1>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Date petitie</CardTitle>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="registration_date">Data inregistrarii</Label>
                <Input
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="petitioner_name">Nume petitionar *</Label>
                <Input
                  id="petitioner_name"
                  {...register('petitioner_name')}
                  placeholder="Numele complet al petitionar"
                />
              ...
              <div className="space-y-2">
                <Label htmlFor="detainee_fullname">Nume detinut (optional)</Label>
                <Input
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="object_description">Descriere obiect (optional)</Label>
                <Textarea
