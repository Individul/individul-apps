      ...
      <div className="flex items-center gap-4">
        ...
        <div className="hidden sm:flex items-center gap-3">
          <span className="inline-flex items-center px-2 py-0.5 bg-gray-50 text-gray-600 border border-gray-100 rounded text-xs">
            {person.active_sentences_count} {person.active_sentences_count === 1 ? 'sentinta' : 'sentinte'}
          </span>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Registru electronic de evidenta si monitorizare
          </p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="relative max-w-md w-full">
          ...
          <input
            type="text"
            placeholder="Cauta dupa nume sau nr. dosar..."
            value={searchQuery}
      ...
      {isLoading ? (
        <div className="flex items-center justify-center h-64">
          <div className="flex items-center gap-2 text-slate-400">
            ...
            <span className="text-sm">Se incarca registrul...</span>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-12 text-center">
          ...
          <h3 className="text-base font-medium text-slate-800 mb-1">
            {activeFilter === 'all' ? 'Nicio persoana inregistrata' : 'Nicio persoana in aceasta categorie'}
          </h3>
          <p className="text-sm text-slate-500 mb-4">
            {activeFilter === 'all'
              ? 'Incepeti prin a adauga prima persoana in registru'
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-3">
            ...
            {activeFilter !== 'all' && ` in categoria "${FILTER_TABS.find(t => t.id === activeFilter)?.label}"`}
          </p>
