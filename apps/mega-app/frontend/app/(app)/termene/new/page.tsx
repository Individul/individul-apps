...
export default function NewPersonPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Persoana a fost adaugata cu succes')
      router.push(`/termene/${person.id}`)
    } catch (error) {
    ...
    <div className="max-w-xl mx-auto">
      ...
      <div className="flex items-start gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500 mt-0.5">
            Completeaza datele persoanei condamnate
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 shadow-sm">
        ...
        <div className="px-6 pt-6 pb-4 mb-2 border-b border-gray-100">
          ...
          <p className="text-xs text-slate-500 mt-0.5">Informatii de identificare</p>
        </div>
          ...
          <div className="mb-5">
            ...
            <div className="relative">
              ...
              <DatePicker
                ...
                placeholder="Selecteaza data inceputului de termen"
                disabled={isLoading}
                className="pl-10"
              />
            </div>
      ...
      <p className="text-xs text-slate-500 mt-4 text-center">
        O sentinta initiala va fi creata automat cu datele introduse.
      </p>
    </div>
  )
}
