  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className="fixed inset-y-0 left-0 z-40 w-60 bg-white border-r border-gray-200/80 hidden lg:flex lg:flex-col">
        ...
        <div className="px-6 py-6">
          <div className="flex items-center gap-2.5">
            <Scale className="h-5 w-5 text-slate-700" strokeWidth={1.5} />
            <span className="font-semibold text-base text-slate-900 tracking-tight">Termene</span>
          </div>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-white border-b border-gray-200 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <Scale className="h-5 w-5 text-slate-700" strokeWidth={1.5} />
          <span className="font-semibold text-slate-900">Termene</span>
        </div>
        <Button
          variant="ghost"
          size="icon"
